...
public class ArchievStats extends AppCompatActivity {
    private MyDataBaseCreator MBC = new MyDataBaseCreator(this);
    private TextView tester2;
    private List<DataEntry> datax;
